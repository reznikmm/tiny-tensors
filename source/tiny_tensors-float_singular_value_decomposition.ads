...
--  diagonal matrix. Note, V is returned not transposed, so to reconstruct use
--  Input = U * S * Transpose (V)

pragma Pure (Tiny_Tensors.Float_Singular_Value_Decomposition);
